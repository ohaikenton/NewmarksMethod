function [time, displacements, velocities, accelerations, u_time] = newmarks_method(M, C, K, Phi, u0, v0, dt, gamma, beta, timesteps, u_g0)
    ...
    u_time = zeros(timesteps, num_dofs);
...
% Extract u1 from the results
u1 = u(:,1);

% Plot u1 against time
figure;
plot(time, u1);
title('u1 over Time');
xlabel('Time (s)');
